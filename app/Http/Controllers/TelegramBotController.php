    ...
    private function handleCallbackQuery($callbackQuery)
    {
        ...
        switch ($data) {
            case 'participate':
                $this->telegram->sendMessage([
                    'chat_id' => $chatId,
                    'text' => "Розыгрыш закончился - не грустите! У вас есть крутой шанс взять реванш в <a href='https://t.me/ozontravel_official/5878'>новом розыгрыше 1 000 000 баллов Ozon!</a> ",
                    'parse_mode' => 'HTML',
                    'reply_markup' => json_encode([
                        'inline_keyboard' => [
                            [
                ...
                $this->telegram->sendMessage([
                    'chat_id' => $chatId,
                    'text' => "
                    ✨Чтобы ваш билет удачи остался активным — <a href='https://cdn1.ozone.ru/s3/promo-sync-api/840920049.html'>подтвердите участие</a>! Жмите «Принять» и&#160;оставайтесь в&#160;игре за&#160;100&#160;000 Ozon-баллов на&#160;двоих — для вас и&#160;вашей тревел-половинки.
                    ",
                    'parse_mode' => 'HTML',
                    'reply_markup' => json_encode([
                        'inline_keyboard' => [
...
//                    ]);
    ...
    private function completeTest($chatId, TravelUser $user, $messageId = null)
    {
        ...
        $this->telegram->sendMessage([
            'chat_id' => $chatId,
            'text' => "
        ✨ Разыгрываем 1&#160;000&#160;000 Ozon баллов целый месяц!\n
