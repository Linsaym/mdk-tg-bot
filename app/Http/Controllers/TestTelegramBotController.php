            ...
            switch (true) {
                case $text === "/i_win":
                    $this->telegram->sendMessage([
                        'chat_id' => $chatId,
                        'text' => "🥳 Поздравляем! Вы стали победителем розыгрыша Ozon Travel Vibe.<br>
Ваш приз — 50&nbsp;000 Ozon-баллов. Вот ваш уникальный код: XXXXX-XXXXX.<br>
Информация о&nbsp;активации промокода и&nbsp;баллах - читайте здесь. (ссылка на&nbsp;правила акции)<br>
А&nbsp;если возникли вопросы, пишите в&nbsp;наш чат поддержки: @Ozontravel1bo<br>
        ...
        switch ($data) {
            case 'participate':
                $this->telegram->sendMessage([
                    'chat_id' => $chatId,
                    'text' => "
                    ✨Чтобы ваш билет удачи остался активным — подтвердите участие! Жмите «Принять» и&nbsp;оставайтесь в&nbsp;игре за&nbsp;100&nbsp;000 Ozon-баллов на&nbsp;двоих — для вас и&nbsp;вашей тревел-половинки.<br>
<br>
